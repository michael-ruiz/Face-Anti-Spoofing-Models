...
class MobileNetV3PAD(nn.Module):
    def __init__(self, num_classes=1, pretrained=True, model_size='small'):
...
if __name__ == '__main__':
    ...
    model = MobileNetV3PAD(num_classes=1, pretrained=True, model_size='small')
    ...
    torch.save({
        ...
        'history': history,
    }, 'best_model_mobilenetv3_pad.pth')
